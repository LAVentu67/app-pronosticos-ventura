...
SINIESTROS DIVERSOS SEGUROS BANORTE GENERALI    SINIESTROS DIVERSOS SEGUROS BANORTE GENERALI    SALVAMENTOS
...
"""
        df_referencia = pd.read_csv(io.StringIO(data_referencia), sep=r'\s\s+', engine='python')
        ...
        df_full['SEGMENTO'].fillna("OTROS", inplace=True)
